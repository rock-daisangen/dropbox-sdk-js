...
const appInfo = {
  LEGACY: {
    accessToken: process.env.LEGACY_TEAM_DROPBOX_TOKEN,
    clientId: process.env.LEGACY_TEAM_CLIENT_ID,
    clientSecret: process.env.LEGACY_TEAM_CLIENT_SECRET,
    refreshToken: process.env.LEGACY_TEAM_REFRESH_TOKEN,
  },
  SCOPED: {
